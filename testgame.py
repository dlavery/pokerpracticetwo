...
class TestGame(unittest.TestCase):
    ...
    def test_allin_w_sidepot(self):
        ...
        (actor, options) = hand.nexttobet()
        self.assertEqual(actor, None)
        hand.setcommunity([Card('K', 'C'), Card('4', 'D'), Card('A', 'H'), Card('5', 'H'), Card('2', 'S')])
        winners = hand.showdown()
        self.assertEqual(len(winners), 2)
        self.assertEqual(winners[0].name(), 'Jill')
        self.assertEqual(winners[0].getchips(), 4000)
        self.assertEqual(winners[1].name(), 'Bob')
        self.assertEqual(winners[1].getchips(), 4800)

    def test_allin_w_smallblind_fold(self):
        game = Game()
        alice = Player('Alice', chipstack=5000)
        bob = Player('Bob', chipstack=5000)
        john = Player('John', chipstack=5000)
        ...
        self.assertEqual(len(winners), 2)
        self.assertEqual(winners[0].name(), 'Jill')
        self.assertEqual(winners[0].getchips(), 3100)
        self.assertEqual(winners[1].name(), 'Bob')
        self.assertEqual(winners[1].getchips(), 4400)
    
    def test_2_allin_rounds(self):
        game = Game()
        alice = Player('Alice', chipstack=5000)
        bob = Player('Bob', chipstack=5000)
        john = Player('John', chipstack=5000)
        ...
        self.assertEqual(winners[0].getchips(), 4000)
        self.assertEqual(winners[1].name(), 'Bob')
        self.assertEqual(winners[1].getchips(), 8000)
    
    def test_allin_not_full_raise(self):
        game = Game()
        alice = Player('Alice', chipstack=5000)
        bob = Player('Bob', chipstack=5000)
        john = Player('John', chipstack=5000)
        jill = Player('Jill', chipstack=300)
        game.addplayer(alice)
        game.addplayer(bob)
        game.addplayer(john)
        game.addplayer(jill)
        ...
        self.assertEqual(len(winners), 1)
        self.assertEqual(winners[0].name(), 'Jill')
        self.assertEqual(winners[0].getchips(), 1200)
    
    def test_allin_not_full_raise_2(self):
        game = Game()
        alice = Player('Alice', chipstack=5000)
        bob = Player('Bob', chipstack=5000)
        john = Player('John', chipstack=5000)
        ...
        self.assertEqual(winners[0].getchips(), 1200)
        self.assertEqual(winners[1].name(), 'Bob')
        self.assertEqual(winners[1].getchips(), 5100)
    
    def test_2_allin_playerout_1(self):
        game = Game()
        alice = Player('Alice', chipstack=5000)
        bob = Player('Bob', chipstack=5000)
        john = Player('John', chipstack=5000)
        ...
        self.assertEqual(winners[0].name(), 'Bob')
        self.assertEqual(winners[1].name(), 'Bob')
        self.assertEqual(bob.getchips(), 9000)
        self.assertEqual(jill.getchips(), 0)
        # Jill is out!
        hand = game.newhand()
        hand.deal()
        self.assertEqual(hand.getplayers()[0].name(), 'Bob')
        self.assertEqual(bob.issmallblind(), True)
        self.assertEqual(john.isbigblind(), True)
    
    def test_2_allin_playerout_2(self):
        game = Game()
        alice = Player('Alice', chipstack=5000)
        ...
        hand.turn()
        hand.river()
        hand.setcommunity([Card('5', 'C'), Card('4', 'D'), Card('A', 'H'), Card('5', 'H'), Card('2', 'S')])
        winners = hand.showdown()
        self.assertEqual(len(winners), 1)
        self.assertEqual(winners[0].name(), 'Jill')
        self.assertEqual(jill.getchips(), 6300)
        self.assertEqual(bob.getchips(), 0)
        # Bob is out!
        hand = game.newhand()
        hand.deal()
        self.assertEqual(hand.getplayers()[0].name(), 'John')
        self.assertEqual(john.isbigblind(), True)
        self.assertEqual(jill.isbigblind(), False)
        self.assertEqual(jill.issmallblind(), False)
    
    def test_2_allin_playerout_3(self):
        game = Game()
        alice = Player('Alice', chipstack=5000)
        bob = Player('Bob', chipstack=1000)
        ...
        self.assertEqual(len(winners), 1)
        self.assertEqual(winners[0].name(), 'Jill')
        self.assertEqual(jill.getchips(), 8300)
        self.assertEqual(alice.getchips(), 4700)
        self.assertEqual(john.getchips(), 0)
        # John is out
        john = None
        hand = game.newhand()
        hand.deal()
        self.assertEqual(hand.getplayers()[0].name(), 'Jill')
        self.assertEqual(jill.isbigblind(), True)
        self.assertEqual(alice.issmallblind(), False)
        (actor, options) = hand.nexttobet()
        self.assertEqual(actor.name(), 'Alice')
